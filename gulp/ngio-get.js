...
module.exports = function (gulp, plugins, config) {
  ...
  gulp.task('_get-pages', ['_get-ts-jade', '_get-extra-dart', '_get-includes', ...(argv.dart ? ['_get-dart-pages'] : [])], () => {
    return Q.all(
      ...
      cpExec(`perl -pi -e 's/<(br class="l-clear-left")>/<!-- $1 -->/' src/angular/_jade/ts/_cache/guide/learning-angular.jade`),
      cpExec(`perl -pi -e 's/<(br class="l-clear-both")>/<!-- $1 -->/' src/angular/_jade/ts/_cache/guide/lifecycle-hooks.jade`)
    );
  });
