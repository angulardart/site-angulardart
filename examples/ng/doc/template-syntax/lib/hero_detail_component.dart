...
@Component(
    ...
    styles: const ['button {margin-left: 8px} div {margin: 8px 0} img {height:24px}'],
...
class HeroDetailComponent implements OnInit {
  ...
  @override
  void ngOnInit() {
    if (hero == null) hero = new Hero(null, '', 'Zzzzzz'); // default sleeping hero
  }
...
@Component(
    ...
    ''',
  styles: const ['.detail { border: 1px solid black; padding: 4px; max-width: 450px; }',
