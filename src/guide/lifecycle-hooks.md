...
[SimpleChange](/reference/api/angular/angular/SimpleChange-class.html) object holding the current and previous property values.
...
[@ViewChild](/reference/api/angular/angular/ViewChild-class.html).
