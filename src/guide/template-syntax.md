...
<div class="l-sub-section" markdown="1">
  ...
  [ViewChild](/reference/api/angular/angular/ViewChild-class.html) and
  [ContentChild](/reference/api/angular/angular/ContentChild-class.html).
</div>
...
<div class="l-sub-section" markdown="1">
  ...
  supported by a [ControlValueAccessor](/reference/api/angular_forms/angular_forms/ControlValueAccessor-class.html)
...
<div class="l-sub-section" markdown="1">
  ...
  and `odd` in the [NgFor API reference](/reference/api/angular/angular/NgFor-class.html).
</div>
...
[NgForm](/reference/api/angular_forms/angular_forms/NgForm-class.html "API: NgForm")
...
[TrackByFn]: /reference/api/angular/angular/TrackByFn.html
