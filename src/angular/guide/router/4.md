...
<?code-excerpt "lib/app_component_4.dart (routes)" replace="/path:.*crisis.*/[!$&!]/g" title?>
```
  @RouteConfig(const [
  ...
  - lib
    ...
    - src
      - crisis_center
        ...
        - crisis_center_home_component.dart
...
<code-tabs>
  ...
  <?code-pane "lib/src/crisis_center/crisis_detail_component_1.dart" replace="/_\d\.html/.html/g" linenums?>
  <?code-pane "lib/src/crisis_center/crisis_center_component_2.dart" linenums?>
  <?code-pane "lib/src/crisis_center/crises_component.dart" linenums?>
  <?code-pane "lib/src/crisis_center/crises_component.html" linenums?>
  <?code-pane "lib/src/crisis_center/mock_crises.dart" linenums?>
</code-tabs>
