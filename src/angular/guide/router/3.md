...
[Tour of Heroes Tutorial Part 5](/angular/tutorial/toh-pt5.html),
and you'll be copying much of the code from there.

Here's how the user will experience this version of the app:

<img class="image-display" src='/resources/images/devguide/router/router-2-anim.gif' alt="App in action">
