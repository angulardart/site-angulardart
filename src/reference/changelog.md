...
TODO: Lots of links to site-webdev that need to be updated/removed.
...
- [Component Styles](/guide/component-styles): dropped "Template inline styles" and
...
The original page, [Testing](/guide/testing),
...
- [Component testing](/guide/testing/component)
  ...
  - <span>Writing component tests</span>
    ...
    - [Services](/guide/testing/component/services): local, external, mock or real
    - [`@Input()` and `@Output()`](/guide/testing/component/input-and-output)
    - [Routing components](/guide/testing/component/routing-components)
- [End-to-end (E2E) testing](/guide/testing/e2e) _(placeholder)_
...
Created an initial [Testing page](/guide/testing) and
